  ...
  <div style="overscroll-behavior: none;">
    ...
    <div class="mt-20 mb-16">
      ...
      <div class="clearfix w-full">
        <div class="bg-gray-300 mx-4 my-2 p-2 rounded-lg inline-block">this is a basic mobile chat layout, built with Tailwind CSS</div>
      </div>
      @else
      <div class="clearfix w-full">
        <div class="text-right">
          <p class="bg-green-300 float-right mx-4 my-2 p-2 rounded-lg inline-block">lets get out</p>
        </div>
      </div>

      <div class="clearfix">
        <div class="bg-gray-300 w-3/4 mx-4 my-2 p-2 rounded-lg clearfix">It will be used for a full tutorial about building a chat app with Vue, Tailwind, and Firebase.</div>
      </div>
      <div class="clearfix">
        <div class="bg-green-300 float-right w-3/4 mx-4 my-2 p-2 rounded-lg clearfix">check my twitter to see when it will be released.</div>
      </div>
      @endif
      @endforeach
    </div>
